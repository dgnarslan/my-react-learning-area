...
export default function Item({ children, id }) {
  ...
  return (
    <button
      ...
      className={
        'flex-auto text-center hover:bg-[color:var(--background-secondary)] transition-colors'
      }
    >
      <div
      ...
      >
        ...
        {active === id && (
          <div
            className={
              'h-[4px] absolute bottom-0 left-0 w-full rounded-full bg-[color:var(--color-primary)]'
            }
          ></div>
        )}
      </div>
