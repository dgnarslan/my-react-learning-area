      ...
      >
        ...
        <Disclosure>
          <Disclosure.Button className="h-[52px] w-full flex items-center justify-between px-4 font-bold hover:bg-[#eff3f41a] transition-colors">
            ...
            <svg className="w-[18.75px] h-[18.75px]" viewBox="0 0 24 24">
              <path
                fill="currentColor"
          ...
          <Disclosure.Panel className="text-gray-500">
            <Link
              to={'/'}
              className={
                'flex items-center px-3 h-11 gap-3 text-[15px] font-medium hover:bg-[#eff3f41a] transition-colors text-white'
              }
            >
