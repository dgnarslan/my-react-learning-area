...
export default function Search() {
  ...
  return (
    <div
      ref={ref}
      className={
        'min-h-[2rem] h-[3.313reö] mb-3 flex items-center sticky top-0 bg-[color:var(--background-primary)] z-10'
      }
    >
      <label
        className={
          'h-[2.688rem] rounded-full bg-[color:var(--background-third)] relative w-full group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]'
        }
      >
        <div className="w-[3.5rem] h-full flex items-center justify-center absolute top-0 left-0 pointer-events-none">
          <svg
            viewBox="0 0 24 24"
            className={
              'min-w-[2rem] h-[1.172rem] text-[color:var(--color-baseSecondary)] group-focus-within:text-[color:var(--color-primary)]'
            }
          >
            <path
              fill="currentColor"
