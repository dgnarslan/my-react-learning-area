...
export default function Topic({ item }) {
  return (
    ...
    >
      <div
        className={
          'text-[0.813rem] text-[color:var(--color-baseSecondary)] leading-4'
        }
      >
        {item.title}
      </div>
      ...
      {item?.postCount && (
        <div
          className={
            'text-[0.813rem] mt-1 text-[color:var(--color-baseSecondary)] leading-4'
          }
        >
      ...
      <Popover className={'absolute top-1.5 right-2'}>
        ...
        <Popover.Panel
          className={
            'w-[24rem] absolute top-2 right-0 bg-[color:var(--background-primary)] shadow-box rounded-xl grid z-[1] overflow-hidden'
          }
        >
          <button
            type={'button'}
            className={
              'py-3 px-4 flex items-center hover:bg-[color:var(--background-secondary)] transition-colors text-start gap-3 font-bold leading-5'
            }
          >
            <svg viewBox="0 0 24 24" className={'h-[1.172rem]'}>
              <path
          ...
          <button
            type={'button'}
            className={
              'py-3  px-4 flex items-center hover:bg-[color:var(--background-secondary)] transition-colors gap-3 text-start font-bold leading-5'
            }
          >
            <svg viewBox="0 0 24 24" className={'h-[1.172rem]'}>
              <path
