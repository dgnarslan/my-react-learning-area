...
export default function More() {
  return (
    <Popover className={'relative'}>
      <Popover.Button className="py-[3px] w-full text-start group outline-none">
        <div className="p-3 rounded-full transition-colors inline-flex items-center gap-5 group-hover:bg-[color:var(--background-third)]">
          <div className="w-[1.641] h-[1.641rem] relative">
      ...
      <Popover.Panel
        className={
          'w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden'
        }
      >
        <button className="px-4 h-14 w-full inline-flex items-center gap-5 text-xl hover:bg-[color:var(--background-secondary)] transition-colors">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="w-full flex items-center justify-between p-4 font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
              ...
              <Disclosure.Panel>
                <Link
                  to={'/'}
                  className={
                    'flex items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors'
                  }
                >
            ...
            <>
              ...
              <Disclosure.Panel>
                ...
                <button
                  ...
                  className={
                    'flex w-full items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors'
                  }
                >
                  <svg viewBox="0 0 24 24" className={'h-[1.172rem]'}>
                    <path
