      ...
      <div className={'mx-8 mb-4'}>
        ...
        >
          ...
          <div className={'flex-1 flex flex-col'}>
            <header className={'mb-0.5 leading-5 flex items-center'}>
              ...
              <div
                className={
                  'ml-1 flex items-center text-[color:var(--color-baseSecondary)]'
                }
              >
                @X - 31d
              </div>
            ...
            <div className={'leading-5 text-[color:var(--color-base)]'}>
              ...
              etiketler ve{' '}
              <Link to={'/x'} className={'text-[#1d9bf0]'}>
                @X{' '}
              </Link>{' '}
        ...
        <div className={'grid gap-3'}>
          ...
          <section>
            ...
            <div
              className={
                'bg-[color:var(--background-secondary)] py-2 mb-3 rounded-2xl flex justify-around items-center'
              }
            >
              {colors.map((c, index) => (
                <button
          ...
          <section>
            <div>
              ...
              <div
                className={
                  'py-2 px-4 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl'
                }
              >
                <button
                  onClick={() => {
